        ...
        <div className="row">
          <div className="col">
            <section>
              ...
              <ul className="nav flex-column">
                <li className="nav-item"><Link href="/info" className="nav-link">О магазине</Link></li>
                <li className="nav-item"><Link href="/goodscatalogue" className="nav-link">Каталог</Link></li>
                <li className="nav-item"><Link href="/contacts" className="nav-link">Контакты</Link></li>
              </ul>
            </section>
          </div>
          <div className="col">
          ...
          <div className="col text-right">
            <section className="footer-contacts">
              <h5>Контакты:</h5>
              <Link className="footer-contacts-phone" href="tel:+7-495-790-35-03">+7 495 79 03 5 03</Link>
              <span className="footer-contacts-working-hours">Ежедневно: с 09-00 до 21-00</span>
              <Link className="footer-contacts-email" href="mailto:office@bosanoga.ru">office@bosanoga.ru</Link>
